...
/* new styles */
body{ color:#D0D0D0; }
h1,h2,h3,h4,h5,h6,strong{ color:var(--gold); }
summary{ font-size:1.5em; font-weight:bold; cursor:pointer; }
.role-title{ font-size:120%; }
.top-skills{ color:#FF8C42; text-align:center; }
</style>
